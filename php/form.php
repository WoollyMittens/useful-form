...
<form action="" id="exampleform" method="get" novalidate>
	...
	<fieldset>
		...
		<label>
			...
			<?php echo reportValidation($name='form_myrange')?>
		</label>
		<script>
		...
		<label>
			...
			<?php echo reportValidation($name='form_mydate')?>
		</label>
		<label>
			Colour:
			<?php echo storeValidation(
				...
				$options='',
				$labels='',
				$message='No colour entered.',
				$custom=''
			)?>
			<?php echo reportValidation($name='form_mycolour')?>
		</label>
	</fieldset>
	<fieldset>
